...
public class ReportAssembler {
	...
	public Report getReport(String type) {
		...
		ReportBodyBuilder bodyBuilder = null;

		// Algorithms to build the body objects are different
		if (type.equals("JSON")) {
			bodyBuilder = new JSONReportBodyBuilder();
		} else if (type.equals("XML")) {
			bodyBuilder = new XMLReportBodyBuilder();			
		} else if (type.equals("HTML")) {
			bodyBuilder = new HTMLReportBodyBuilder();
		}

		ReportBody reportBody = bodyBuilder.getReportBody(this.saleEntry);

...
public class Report {
	...
	public Report(String string) {
		...
		ReportFactoryManager reportFactoryManager = new ReportFactoryManager();
		ReportFactory reportFactory = reportFactoryManager.createReportFactory(string);

		this.header = reportFactory.createReportHeader();
		this.body = reportFactory.createReportBody();
		this.footer = reportFactory.createReportFooter();
	}
